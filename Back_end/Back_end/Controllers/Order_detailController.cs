...
namespace Back_end.Controllers
{
    ...
    public class Order_detailController : ControllerBase
    {
        ...
        [HttpPost("create")]
        public async Task<ActionResult<Order_detailDto>> Create([FromBody] Order_detail dto)
        {
        ...
        [HttpPut("update")]
        public async Task<ActionResult<Order_detailDto>> Update([FromBody] Order_detail dto)
        {
